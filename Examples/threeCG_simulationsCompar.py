# -*- coding: utf-8 -*-
"""
Created on Mon Jul 11 16:30:37 2022
...
for n in range(len(IN_temp1)):
    ...
    plt.plot(model1.t/60,(S3/REP_con)*100,color='black',linewidth=2,linestyle='-')
...
for n in range(len(IN_temp1)):
    ...
    model2.DNA_species('output','O4',temp_con=IN_temp3[n])
    ...
    REP3 = model2.output_concentration['REP3']
    ...
    plt.plot(model2.sol.t/60,(1-REP3/REP_con)*100,color='pink',linewidth=2,linestyle='--')
    ...
    plt.legend(['S1v2','S2v2','S3v2','S1v1','S2v1','S3v1'],frameon=False,fontsize=8)
        
    

plt.suptitle('Three CG Simulation Comparison')
