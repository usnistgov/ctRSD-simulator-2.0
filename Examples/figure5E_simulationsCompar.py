# -*- coding: utf-8 -*-
"""
Created on Wed Jul  6 15:13:34 2022
...
model.molecular_species('gate{4,1}',DNA_con=25)
model.molecular_species('gate{5,1}',DNA_con=25)
...
for n in range(len(IN3)):
   ...
   plt.subplot(2,4,1)
   plt.plot(model.t/60,(S2/REP_con)*100,color='pink',linewidth=2,linestyle='--')
...
plt.xlabel('Time (min)',fontsize=fs)
plt.ylabel('Reacted reporter (%)',fontsize=fs)
plt.title('Figure 5E Comparison')