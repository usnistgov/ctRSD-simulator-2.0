# -*- coding: utf-8 -*-
"""
Created on Tue Jul 12 14:20:28 2022
...
def pattern_feeder(input_pattern):
    t_sim = np.linspace(0,6,1001)*3600 # seconds
...
if __name__ == '__main__':
    ...
    outputs = pool.map(pattern_feeder, all_ip)
    ...
    for i in range(len(all_ip)):
        ...
        plt.plot(t/60,(S1/REP_con)*100,color=[0,0,1],linewidth=1.5,linestyle='--')
        plt.fill_between(t/60,(S1/REP_con)*100,color=[0,0,1],alpha=0.1)
        plt.plot(t/60,(S2/REP_con)*100,color=[1,0,0],linewidth=1.5,linestyle='--')
        plt.fill_between(t/60,(S2/REP_con)*100,color=[1,0,0],alpha=0.1)
